...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "sub"         # 用户名
UUID = "30f535bc-a08a-4b21-b492-5b5f3852a0cd"                     # UUID，留空则自动生成
PORT = 31800                   # Vmess端口，留空或0则自动生成
DOMAIN = "streamlit.snake.pp.ua"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiM2VmOTRkODViNGQzZmQ5OTc2Yzc5MDFmZmUyYWZkNTUiLCJ0IjoiZjNlZjRlODAtMWY0NS00OGMxLWE3NTEtNzc4ZDA0NjE5ODIyIiwicyI6Ik0yVm1NRFV6TkRJdE1EVXlNUzAwWkRSaExXSTNOV1F0TnpneU9EVTVPV1ptTnpjNCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
